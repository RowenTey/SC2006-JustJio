export default [
  {
    name: 'Spin The Wheel',
    imageURL:
      'https://tekhnologic.files.wordpress.com/2018/04/the-spinning-wheel-16.jpg',
    isStatic: false,
    shouldNavigate: 'SpinTheWheel',
  },

  {
    ...
    isStatic: true,
    shouldNavigate: 'PartyGamesRules',
  },
...

  {
    ...
    imageURL: 'https://cdn.appuals.com/wp-content/uploads/2021/10/intro-1.jpg',
    description:
  ...
  {
    name: 'Heads Up',
    imageURL: 'https://i.ytimg.com/vi/Qm5-zohOKFc/maxresdefault.jpg',
    description:
  ...
  {
    name: 'Mafia',
    imageURL: 'https://miro.medium.com/max/1280/1*WeCoFpfJ5DcpUwRA2ansDQ.jpeg',
    description:
  ...
  {
    name: 'Mahjong',
    imageURL: 'https://www.lovehkfilm.com/reviews_2/ab5734/bet_to_basic_a.jpg',
    description:
